...
const int rtcCePin = 10;  // RTC Chip Enable
const int rtcIoPin = 11;  // RTC Input/Output
const int rtcSclkPin = 12;  // RTC Serial Clock

							// Create a DS1302 object.
DS1302 rtc(rtcCePin, rtcIoPin, rtcSclkPin);

// Create LCD object 16 x 2 with address
// A1 0 = 3D, A0 0 = 3E, 000 = 27
...
void setup() {
	...
	lcd2.createChar(0, smileGoate);
	lcd2.createChar(1, tempSymbol);
	lcd2.createChar(2, humidSymbol);
	lcd2.createChar(3, smileHair);

	lcd1.createChar(0, leftBoarder);
	lcd1.createChar(1, rightBoarder);
